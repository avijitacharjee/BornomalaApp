...
public class WritingView extends View {
    ...
    public WritingView(Context context, AttributeSet attributeSet, int defStyles) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    takeScreenShot(WritingView.this).compress(Bitmap.CompressFormat.PNG, 100, finalFos);
                } catch (Exception e) {
                    e.printStackTrace();
                } finally {
                    try {
